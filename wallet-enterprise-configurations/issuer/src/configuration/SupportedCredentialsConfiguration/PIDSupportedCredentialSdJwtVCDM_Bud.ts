...
export class PIDSupportedCredentialSdJwtVCDM_Bud implements VCDMSupportedCredentialProtocol {
	...
	getDisplay() {
		return {
			name: `PID ARF 1.8 (${this.getFormat()}) - Bank`,
