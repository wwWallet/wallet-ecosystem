const locale = {
	en: {
		...
		index: {
			...
			phrase: "I am a greek citizen",
			proceed: "Proceed",
			heading: "National Verifiable ID Issuer",
			paragraph: "This is a portal where Greek citizen can receive their digital Verifiable ID in their wallet. To proceed you must first have an EBSI conformant digital wallet. This Verifiable ID will contain a the Social Security Number as a personal identifier.",
