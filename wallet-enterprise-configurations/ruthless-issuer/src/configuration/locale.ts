const locale = {
	en: {
		...
		header: {
			title: "RUTHLESS Issuer",
			subtitle: "Receive your verifiable RUTHLESS Card",
		},
		plainHeader: {
		...
		index: {
			header: "RUTHLESS Issuer",
			phrase: "I want to receive an RUTHLESS Card",
			proceed: "Proceed",
			heading: "RUTHLESS Card Issuer",
			paragraph: "This is a portal where citizens can receive their digital RUTHLESS Card in their wallet. To proceed you must first have an EBSI conformant digital wallet. This Verifiable EHIC Card will contain a the Social Security Number as a personal identifier.",
